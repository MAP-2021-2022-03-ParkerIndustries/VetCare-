...
import 'package:vetclinic/ui/screen/vet_update_booking/update_booking_detail_view.dart';
...
class _VetBookingListBodyState extends State<VetBookingListBody> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: View<VetBookingListVM>(builder: (context, viewModel) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            DateTime dateTime = DateTime.fromMillisecondsSinceEpoch(
                viewModel.listBooking[index].dateBooking);
